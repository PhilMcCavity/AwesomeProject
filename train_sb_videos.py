...
def main(args: argparse.Namespace) -> None:
    ...
    model.learn(total_timesteps=args.max_steps, log_interval=args.log_interval,
                callback=[eval_callback, checkpoint_callback, wandb_callback, video_logger_callback])
...
class VideoLoggerCallback(BaseCallback):
    ...
    def _log_videos(self):
        ...
        for video_file in new_videos:
            ...
            wandb.log({"video": wandb.Video(os.path.join(self.video_folder, video_file), fps=4, format="mp4")})
