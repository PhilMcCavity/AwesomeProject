...
def main(args: argparse.Namespace):
    ...
    model = PPO("MlpPolicy", env, verbose=1, tensorboard_log=log_dir, learning_rate=args.learning_rate,
...
def parse_args():
    ...
    parser.add_argument('--env_name', type=str, default='LunarLander-v3', help='Environment name',
                        choices=['FrozenLake-v1', 'MountainCar-v0', 'CartPole-v1', 'Acrobot-v1', 'Pendulum-v1', 'LunarLander-v3', 'CarRacing-v2'])
